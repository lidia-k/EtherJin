"""
Django settings for etherscan_project project.
...
ROOT_URLCONF = 'etherscan_project.urls'
...
WSGI_APPLICATION = 'etherscan_project.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "etherscan_project/static",
]
